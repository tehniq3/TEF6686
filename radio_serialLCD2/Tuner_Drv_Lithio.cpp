...
[ 15:0 ]
	tuning frequency
	FM 6500 ï¿½ 10800 65.00 ï¿½ 108.00 MHz / 10 kHz step size
	AM LW 144 ï¿½ 288 144 ï¿½ 288 kHz / 1 kHz step size
	MW 522 ï¿½ 1710 522 ï¿½ 1710 kHz / 1 kHz step size
	SW 2300 ï¿½ 27000 2.3 ï¿½ 27 MHz / 1 kHz step size
*/
...
2 afu_bandwidth
	...
	560 ï¿½ 3110 [*0.1 kHz] = IF bandwidth 56 ï¿½ 311 kHz; narrow ï¿½ wide
	2360 = 236 kHz (default)
3 afu_mute_time
	[ 15:0 ]
	AF_update inaudible mute slope time
	250 ï¿½ 1000 [* 1 us] = 0.25 ï¿½ 1 ms
	1000 = 1 ms (default)
4 afu_sample_time
	[ 15:0 ]
	AF_update sampling time
	1000 ï¿½ 20000 [* 1 us] = 1 ï¿½ 20 ms
	2000 = 2 ms (default)
*/
...
2 bandwidth
	[ 15:0 ]
	fixed IF bandwidth
	FM 560 ï¿½ 3110 [*0.1 kHz] = IF bandwidth 56 ï¿½ 311 kHz; narrow ï¿½ wide
	2360 = 236 kHz (default)
	AM 30 ï¿½ 80 [*0.1 kHz] = IF bandwidth 3 ï¿½ 8 kHz; narrow ï¿½ wide
	40 = 4.0 kHz (default)
3 control_sensitivity
	[ 15:0 ]
	FM automatic IF bandwidth control sensitivity
	500 ï¿½ 1500 [*0.1 %] = 50 ï¿½ 150 % relative adjacent channel sensitivity
	1000 = 100 % (default)
...
1 start
	[ 15:0 ]
	RF AGC start
	FM 830 ï¿½K 920 [*0.1 dBï¿½ï¿½V) = 83 ï¿½K 92 dBï¿½ï¿½V
	920 = 92 dBï¿½ï¿½V (default)
	AM 940 ï¿½K 1030 (*0.1 dBï¿½ï¿½V) = 94 ï¿½K 103 dBï¿½ï¿½V
	1000 = 100 dBï¿½ï¿½V (default)
2 extension
	[ 15:0 ]
	RF AGC step extension
	FM 0 = integrated steps only (default)
	1 = AGC step extension from control output (GPIO feature ï¿½ï¿½AGCï¿½ï¿½)
	AM reserved
*/
...
1 attenuation
	[ 15:0 ]
	LNA gain reduction
	0 / 60 / 120 / 180 / 240 / 300 / 360 (*0.1 dB) = 0 ï¿½ 36 dB antenna
...
60 ï¿½ï¿½ 2000 (ms) = 60 ms ï¿½ï¿½ 2 s slow attack time
500 = 500 ms (default)
2  slow_decay 
[ 15:0 ]
slow decay time of weak signal handling
120 ï¿½ï¿½ 12500 (ms) = 120 ms ï¿½ï¿½ 12.5 s slow attack time
2000 = 2 s (default)
3  fast_attack 
[ 15:0 ]
fast attack time of weak signal handling
10 ï¿½ï¿½ 1200 (*0.1 ms) = 1 ms ï¿½ï¿½ 120 ms fast attack time
20 = 2 ms (default)
4  fast_decay 
[ 15:0 ]
fast decay time of weak signal handling
20 ï¿½ï¿½ 5000 ( *0.1 ms) = 2 ms ï¿½ï¿½ 500 ms fast attack time
20 = 2 ms (default)
...
2 sensitivity
	[ 15:0 ]
	trigger sensitivity
	500 ï¿½ 1500 [*0.1 %] = 50 ï¿½ 150 % relative trigger sensitivity
	1000 = 100 % (default)
*/
...
1 timeconstant
	...
	500 = 50 ï¿½ï¿½s deemphasis (default)
	750 = 75 ï¿½ï¿½s deemphasis
*/
...
1 slow_attack
	[ 15:0 ]
	slow attack time of weak signal handling
	60 ï¿½ 2000 (ms) = 60 ms ï¿½ 2 s slow attack time
	120 = 120 ms (default)
2 slow_decay
	[ 15:0 ]
	slow decay time of weak signal handling
	120 ï¿½ 12500 (ms) = 120 ms ï¿½ 12.5 s slow attack time
	500 = 500 ms (default)
3 fast_attack
	[ 15:0 ]
	fast attack time of weak signal handling
	10 ï¿½ 1200 (*0.1 ms) = 1 ms ï¿½ 120 ms fast attack time
	20 = 2 ms (FM default) / 120 = 12 ms (AM default)
4 fast_decay
	[ 15:0 ]
	fast decay time of weak signal handling
	20 ï¿½ 5000 ( *0.1 ms) = 2 ms ï¿½ 500 ms fast attack time
...
2 start 
	[ 15:0 ] 0 ï¿½K 500 [*0.1 dBï¿½ï¿½V] = control when level falls below 0 dBï¿½ï¿½V ï¿½K 50 dBï¿½ï¿½V
	150 = 15 dBï¿½ï¿½V (FM default) / 280 = 28 dBï¿½ï¿½V (AM default)
3 slope
	60 ï¿½K 300 [*0.1 dB] = control over level range of 6 dB ï¿½K 30 dB
...
2 start
	...
	0 ï¿½ 800 [*0.1 %] = control when noise above 0ï¿½ 80% of USN detector
	500 = 50% (default)
3 slope
	[ 15:0 ]
	FM weak signal handling noise range
	100 ï¿½ 1000 [*0.1 %] = control over range of 10ï¿½ 100% of USN detector
	1000 = 100% (default)
*/
...
2 start
	...
	0 ï¿½ 800 [*0.1 %] = control when mph above 0ï¿½ 80% of WAM detector
	500 = 50% (default)
3 slope
	[ 15:0 ]
	FM weak signal handling multipath range
	100 ï¿½ 1000 [*0.1 %] = control over range of 10ï¿½ 100% of WAM detector
	1000 = 100% (default)
*/
...
2 limit
	...
	0 ï¿½ 400 [*0.1 dB] = 0 ï¿½ 40 dB softmute maximum attenuation
...
2 start
	...
	100 ï¿½ 1000 [*0.1 %] = control when modulation falls below 10% ï¿½ 100%
	250 = 25% (default)
	( note : for FM band 100% modulation equals 75 kHz deviation )
3 slope
	[ 15:0 ]
	weak signal handling modulation range
	30 ï¿½ 1000 (*0.1 %) = control over modulation range of 3% ï¿½ 100%
	130 = 13% (default)
4 shift
	[ 15:0 ]
	weak signal handling control shift
	50 ï¿½ 1000 (*0.1 %) = maximum weak signal control shift of 5% ï¿½ 100%
	500 = 50% (default)
...
2 start
	...
	200 ï¿½K 600 [*0.1 dBï¿½ï¿½V] = control when level is below 20 dBï¿½ï¿½V ï¿½K 60 dBï¿½ï¿½V
	360 = 36 dBï¿½ï¿½V (FM default) / 400 = 40 dBï¿½ï¿½V (AM default)
3 slope
	[ 15:0 ]
...
2 limit
	...
	FM 1500 ï¿½ 7000 [*1 Hz] = 1.5 ï¿½ 7 kHz Highcut maximum -3 dB att.
	4000 = 4 kHz (default)
	AM 1350 ï¿½ 7000 [*1 Hz] = 1.35 ï¿½ 7 kHz Highcut maximum -3 dB att.
...
2 limit
	...
	2700 ï¿½ 15000 [*1 Hz] = 2.7 ï¿½ 15 kHz -3 dB attenuation fo
...
2 limit
	...
	10 ï¿½ 200 [Hz] = 10 ï¿½ 200 Hz Lowcut minimum -3 dB attenuation
	20 = 20 Hz (default)
...
4 shift
	...
	50 ï¿½ 1000 (*0.1 %) = maximum weak signal control shift of 5% ï¿½ 100%
	500 = 50% (default)
	(percentage of the linear control range from _Min limit to ï¿½monoï¿½)
...
2 start
	[ 15:0 ]
	weak signal handling level start
	300 ï¿½K 600 [*0.1 dBï¿½ï¿½V] = control when level below 30 dBï¿½ï¿½V ï¿½K 60 dBï¿½ï¿½V
	460 = 46 dBï¿½ï¿½V (default)
3 slope
	[ 15:0 ]
	weak signal handling level range
	60 ï¿½K 300 [*0.1 dB] = control over level range of 6 dB ï¿½K 30 dB
...
2 limit
	...
	60 ï¿½ 400 [0.1* dB] = 6 ï¿½ 40 dB Stereo minimum channel separation
	400 = 40 dB (default)
...
1 gain
	[ 15:0 ] (signed)
	channel gain
	-120 ï¿½ +60 [*0.1 dB] = -12 ï¿½ +6 dB analog radio signal gain
	0 = 0 dB (default)
*/
...
3 interface
	...
	2 = data-available status output; active low (GPIO feature ï¿½DAVNï¿½)
	4 = legacy 2-wire demodulator data and clock output (ï¿½RDDAï¿½ and ï¿½RDCLï¿½)
*/
...
[ 15:0 ]
	...
	[ 8:0 ] : 1 ï¿½ 320 (* 0.1 ms) = set flag at 0.1 ï¿½ 32 ms after tuning ready
	[15] : 1 = set flag when FM AF_Update quality result is available
2 interface
	[ 15:0 ]
	quality status pin signal functionality
	0 = no pin interface (default)
	2 = quality status output; active low (ï¿½QSIï¿½)
*/
...
4 gain
	...
	-180 ï¿½ +60 [*0.1 dB] = -18 ï¿½ +6 dB digital radio signal gain
	0 = 0 dB (default)
*/
...
1 source
	...
	32 = Iï¿½S digital audio input (IIS_SD_0)
...
1 signal
	[ 15:0 ]
	audio output
	33 = Iï¿½S digital audio IIS_SD_1 (output)
	128 = DAC L/R output
2 source
	[ 15:0 ]
	source
	4 = analog radio
	32 = Iï¿½S digital audio IIS_SD0 (input)
...
[ 15:0 ]
	...
	32 = Iï¿½S digital audio IIS_SD_0 (input)
	33 = Iï¿½S digital audio IIS_SD_1 (output)
(2) mode
	0 = off (default)
...
(3) format
	...
	16 = Iï¿½S 16 bits (fIIS_BCK = 32 * samplerate)
	32 = Iï¿½S 32 bits (fIIS_BCK = 64 * samplerate) (default)
...
2 gain
	...
	-120 ï¿½ +60 [*0.1 dB] = -12 ï¿½ +6 dB external source signal gain
	0 = 0 dB (default)
*/
...
2 offset
	[ 15:0 ]
	DC offset
	-32768 ï¿½ + 32767 (* 1 LSB of 16 bit) = max negative ï¿½ max positive.
	0 = no offset (default)
3 amplitude1
	[ 15:0 ] signed
	wave 1 amplitude
	-300 ï¿½ 0 (*0.1 dB) = -30 ï¿½ 0 dB
	-200 = -20 dB (default)
4 frequency1
	[ 15:0 ]
	wave 1 frequency
	10 ï¿½ 20000 (*1 Hz) = 10 Hz ï¿½ 20 kHz
	400 = 400 Hz (default)
5 amplitude2
	[ 15:0 ] signed
	wave 2 amplitude
...
3 feature
	...
	2 = general purpose output ï¿½0ï¿½ (FM / AM)
	3 = general purpose output ï¿½1ï¿½ (FM / AM)
	257 = output RDS (FM : see cmd 81 ï¿½DAVNï¿½)
	258 = output QSI (FM / AM : see cmd 82 ï¿½timer and AF_Update flagï¿½)
	259 = output QSI + RDS (active ï¿½lowï¿½ if ï¿½DAVNï¿½ is active or ï¿½QSIï¿½ is active)
	260 = output RDDA (FM : see cmd 81 ï¿½RDDA, RDCL legacy optionï¿½)
	261 = output RDCL (FM : see cmd 81 ï¿½RDDA, RDCL legacy optionï¿½)
	262 = output AGC (FM : see cmd 11 ï¿½AGC step extensionï¿½)
*/
...
4 wam
	[ 15:0 ]
	FM wideband-AMï¿½ multipath detector
...
6 bandwidth
	[ 15:0 ]
	IF bandwidth
	FM 560 ...3110 [*0.1 kHz] = IF bandwidth 56 ... 311 kHz; narrow ï¿½K wide
	AM 30 ... 80 [*0.1 kHz] = IF bandwidth 3 ... 8 kHz; narrow ï¿½K wide
7 modulation
	[ 15:0 ]
	modulation detector
...
/*
status	= 1 ï¿½ 320 (* 0.1 ms) = 0.1 ï¿½ 32 ms after tuning
level		= -200 ... 1200 (0.1 * dBuV) = -20 ... 120 dBuV RF input level
usn		=  0 ï¿½ 1000 (*0.1 %) = 0 ï¿½ 100% relative usn detector result
wam		=  0 ï¿½ 1000 (*0.1 %) = 0 ï¿½ 100% relative wam detector result
offset	 = -1200 ï¿½ 1200 (*0.1 kHz) = -120 kHz ï¿½ 120 kHz radio frequency error
bandwith	 = FM 560 ï¿½ 3110 [*0.1 kHz] = IF bandwidth 56 ï¿½ 311 kHz; narrow ï¿½ wide
			AM 30 ï¿½ 80 [*0.1 kHz] = IF bandwidth 3 ï¿½ 8 kHz; narrow ï¿½ wide
modulation	 = FM 0 ï¿½ 1000 [*0.1 %] = 0 ï¿½ 100% modulation = 0 ï¿½ 75 kHz FM dev.
				1000 ï¿½ 2000 [*0.1 %] = 100% ï¿½ 200% over-modulation range
			AM 0 ï¿½ 1000 [*0.1 %] = 0 ï¿½ 100% AM modulation index
			1000 ï¿½ 2000 [*0.1 %] = 100% ï¿½ 200% peak modulation range
...
1 status
	...
	1 = type B; A-B-Cï¿½-D group (with PI code in block A and Cï¿½)
	[11:10] = reserved
...
1 input_att
	...
	FM 0 ï¿½ 420 (0.1* dB) = 0 ï¿½ 42 dB attenuation
	AM 0 ï¿½ 420 (0.1* dB) = 0 ï¿½ 42 dB attenuation
2 feedback_att
	[ 15:0 ]
	RF AGC feedback attenuation
	FM 0 ï¿½ 60 (0.1* dB) = 0 ï¿½ 6 dB attenuation
	AM 0 ï¿½ 180 (0.1* dB) = 0 ï¿½ 18 dB attenuation
*/
...
1 softmute Softmute control state
	0 ï¿½ 1000 (*0.1%) = 0 % minimum ï¿½ 100 % max. softmute attenuation
2 highcut Highcut control state
	0 ï¿½ 1000 (*0.1%) = 0 % minimum ï¿½ 100 % max. audio freq. limitation
3 stereo FM Stereo blend control state
	0 ï¿½ 1000 (*0.1%) = 0 % minimum ï¿½ 100 % max. stereo att. (= mono)
*/
...
1 device 
	...
	8 = TEF668x ï¿½Atomic-2ï¿½ series
	[ 7:0 ] variant identifier
	15 = TEF6653 ï¿½Atomic-2 Standardï¿½
	13 = TEF6657 ï¿½Atomic-2 Premiumï¿½
	12 = TEF6659 ï¿½Atomic-2 Premium DRï¿½
2 hw_version 
	hardware version
	[ 15:8 ] major number
	1 = ï¿½V1ï¿½
...
module 64 APPL
cmd 131 Get_LastWrite | size/module, cmd/ index, parameter1, parameter2, parameter3, ï¿½

index 
1 size/module transmission size (number of parameters) and module number
	[ 15:8 ] = 0 ï¿½ 6 : number of parameters of the last write transmission
	[ 7:0 ] = 0 ï¿½ 255 : module value of the last write transmission
2 cmd/index
	command byte number and index byte value
	[ 15:8 ] = 0 ï¿½ 255 : cmd value of the last write transmission
	[ 7:0 ] = 0 ... 255 : index value of the last write transmission
3 parameter1 first parameter
	0 ï¿½ 65535 = value of the first parameter (when available)
4 parameter2 second parameter
	0 ï¿½ 65535 = value of the second parameter (when available)
5 parameter3 third parameter
	0 ï¿½ 65535 = value of the third parameter (when available)
6 parameter4 fourth parameter
	0 ï¿½ 65535 = value of the fourth parameter (when available)
7 parameter5 fifth parameter
	0 ï¿½ 65535 = value of the fifth parameter (when available)
*/
