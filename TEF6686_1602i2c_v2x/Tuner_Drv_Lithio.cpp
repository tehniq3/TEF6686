...
[ 15:0 ]
	tuning frequency
	FM 6500 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 10800 65.00 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 108.00 MHz / 10 kHz step size
	AM LW 144 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 288 144 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 288 kHz / 1 kHz step size
	MW 522 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1710 522 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1710 kHz / 1 kHz step size
	SW 2300 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 27000 2.3 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 27 MHz / 1 kHz step size
*/
...
2 afu_bandwidth
	...
	560 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 3110 [*0.1 kHz] = IF bandwidth 56 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 311 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½ wide
	2360 = 236 kHz (default)
3 afu_mute_time
	[ 15:0 ]
	AF_update inaudible mute slope time
	250 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 [* 1 us] = 0.25 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1 ms
	1000 = 1 ms (default)
4 afu_sample_time
	[ 15:0 ]
	AF_update sampling time
	1000 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 20000 [* 1 us] = 1 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 20 ms
	2000 = 2 ms (default)
*/
...
2 bandwidth
	[ 15:0 ]
	fixed IF bandwidth
	FM 560 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 3110 [*0.1 kHz] = IF bandwidth 56 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 311 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½ wide
	2360 = 236 kHz (default)
	AM 30 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 80 [*0.1 kHz] = IF bandwidth 3 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 8 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½ wide
	40 = 4.0 kHz (default)
3 control_sensitivity
	[ 15:0 ]
	FM automatic IF bandwidth control sensitivity
	500 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1500 [*0.1 %] = 50 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 150 % relative adjacent channel sensitivity
	1000 = 100 % (default)
...
1 start
	[ 15:0 ]
	RF AGC start
	FM 830 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 920 [*0.1 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V) = 83 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 92 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V
	920 = 92 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (default)
	AM 940 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 1030 (*0.1 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V) = 94 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 103 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V
	1000 = 100 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (default)
2 extension
	[ 15:0 ]
	RF AGC step extension
	FM 0 = integrated steps only (default)
	1 = AGC step extension from control output (GPIO feature ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½AGCÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½)
	AM reserved
*/
...
1 attenuation
	[ 15:0 ]
	LNA gain reduction
	0 / 60 / 120 / 180 / 240 / 300 / 360 (*0.1 dB) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 36 dB antenna
...
60 ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2000 (ms) = 60 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2 s slow attack time
500 = 500 ms (default)
2  slow_decay 
[ 15:0 ]
slow decay time of weak signal handling
120 ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 12500 (ms) = 120 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 12.5 s slow attack time
2000 = 2 s (default)
3  fast_attack 
[ 15:0 ]
fast attack time of weak signal handling
10 ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1200 (*0.1 ms) = 1 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 120 ms fast attack time
20 = 2 ms (default)
4  fast_decay 
[ 15:0 ]
fast decay time of weak signal handling
20 ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 5000 ( *0.1 ms) = 2 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½ 500 ms fast attack time
20 = 2 ms (default)
...
2 sensitivity
	[ 15:0 ]
	trigger sensitivity
	500 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1500 [*0.1 %] = 50 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 150 % relative trigger sensitivity
	1000 = 100 % (default)
*/
...
1 timeconstant
	...
	500 = 50 ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½s deemphasis (default)
	750 = 75 ÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½s deemphasis
*/
...
index 1 step1
	...
	-60 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 0 (*0.1 dB) = -6 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 0 dB
...
1 offset
	[ 15:0 ] signed
	level offset
	-480 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +150 (*0.1 dB) = -48 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +15 dB
	0 = 0 dB (default)
*/
...
1 slow_attack
	[ 15:0 ]
	slow attack time of weak signal handling
	60 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2000 (ms) = 60 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2 s slow attack time
	120 = 120 ms (default)
2 slow_decay
	[ 15:0 ]
	slow decay time of weak signal handling
	120 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 12500 (ms) = 120 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ 12.5 s slow attack time
	500 = 500 ms (default)
3 fast_attack
	[ 15:0 ]
	fast attack time of weak signal handling
	10 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1200 (*0.1 ms) = 1 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ 120 ms fast attack time
	20 = 2 ms (FM default) / 120 = 12 ms (AM default)
4 fast_decay
	[ 15:0 ]
	fast decay time of weak signal handling
	20 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 5000 ( *0.1 ms) = 2 ms ÃƒÂ¯Ã‚Â¿Ã‚Â½ 500 ms fast attack time
...
2 start 
	[ 15:0 ] 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 500 [*0.1 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V] = control when level falls below 0 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V ÃƒÂ¯Ã‚Â¿Ã‚Â½K 50 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V
	150 = 15 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (FM default) / 280 = 28 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (AM default)
3 slope
	60 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 300 [*0.1 dB] = control over level range of 6 dB ÃƒÂ¯Ã‚Â¿Ã‚Â½K 30 dB
...
2 start
	...
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 800 [*0.1 %] = control when noise above 0ÃƒÂ¯Ã‚Â¿Ã‚Â½ 80% of USN detector
	500 = 50% (default)
3 slope
	[ 15:0 ]
	FM weak signal handling noise range
	100 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 [*0.1 %] = control over range of 10ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100% of USN detector
	1000 = 100% (default)
*/
...
2 start
	...
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 800 [*0.1 %] = control when mph above 0ÃƒÂ¯Ã‚Â¿Ã‚Â½ 80% of WAM detector
	500 = 50% (default)
3 slope
	[ 15:0 ]
	FM weak signal handling multipath range
	100 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 [*0.1 %] = control over range of 10ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100% of WAM detector
	1000 = 100% (default)
*/
...
2 limit
	...
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 400 [*0.1 dB] = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 40 dB softmute maximum attenuation
...
2 start
	...
	100 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 [*0.1 %] = control when modulation falls below 10% ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100%
	250 = 25% (default)
	( note : for FM band 100% modulation equals 75 kHz deviation )
3 slope
	[ 15:0 ]
	weak signal handling modulation range
	30 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1 %) = control over modulation range of 3% ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100%
	130 = 13% (default)
4 shift
	[ 15:0 ]
	weak signal handling control shift
	50 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1 %) = maximum weak signal control shift of 5% ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100%
	500 = 50% (default)
...
2 start
	...
	200 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 600 [*0.1 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V] = control when level is below 20 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V ÃƒÂ¯Ã‚Â¿Ã‚Â½K 60 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V
	360 = 36 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (FM default) / 400 = 40 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (AM default)
3 slope
	[ 15:0 ]
...
2 limit
	...
	FM 1500 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 7000 [*1 Hz] = 1.5 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 7 kHz Highcut maximum -3 dB att.
	4000 = 4 kHz (default)
	AM 1350 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 7000 [*1 Hz] = 1.35 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 7 kHz Highcut maximum -3 dB att.
...
2 limit
	...
	2700 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 15000 [*1 Hz] = 2.7 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 15 kHz -3 dB attenuation fo
...
2 limit
	...
	10 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 200 [Hz] = 10 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 200 Hz Lowcut minimum -3 dB attenuation
	20 = 20 Hz (default)
...
4 shift
	...
	50 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1 %) = maximum weak signal control shift of 5% ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100%
	500 = 50% (default)
	(percentage of the linear control range from _Min limit to ÃƒÂ¯Ã‚Â¿Ã‚Â½monoÃƒÂ¯Ã‚Â¿Ã‚Â½)
...
2 start
	[ 15:0 ]
	weak signal handling level start
	300 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 600 [*0.1 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V] = control when level below 30 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V ÃƒÂ¯Ã‚Â¿Ã‚Â½K 60 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V
	460 = 46 dBÃƒÂ¯Ã‚Â¿Ã‚Â½ÃƒÂ¯Ã‚Â¿Ã‚Â½V (default)
3 slope
	[ 15:0 ]
	weak signal handling level range
	60 ÃƒÂ¯Ã‚Â¿Ã‚Â½K 300 [*0.1 dB] = control over level range of 6 dB ÃƒÂ¯Ã‚Â¿Ã‚Â½K 30 dB
...
2 limit
	...
	60 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 400 [0.1* dB] = 6 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 40 dB Stereo minimum channel separation
	400 = 40 dB (default)
...
1 gain
	[ 15:0 ] (signed)
	channel gain
	-120 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +60 [*0.1 dB] = -12 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +6 dB analog radio signal gain
	0 = 0 dB (default)
*/
...
3 interface
	...
	2 = data-available status output; active low (GPIO feature ÃƒÂ¯Ã‚Â¿Ã‚Â½DAVNÃƒÂ¯Ã‚Â¿Ã‚Â½)
	4 = legacy 2-wire demodulator data and clock output (ÃƒÂ¯Ã‚Â¿Ã‚Â½RDDAÃƒÂ¯Ã‚Â¿Ã‚Â½ and ÃƒÂ¯Ã‚Â¿Ã‚Â½RDCLÃƒÂ¯Ã‚Â¿Ã‚Â½)
*/
...
[ 15:0 ]
	...
	[ 8:0 ] : 1 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 320 (* 0.1 ms) = set flag at 0.1 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 32 ms after tuning ready
	[15] : 1 = set flag when FM AF_Update quality result is available
2 interface
	[ 15:0 ]
	quality status pin signal functionality
	0 = no pin interface (default)
	2 = quality status output; active low (ÃƒÂ¯Ã‚Â¿Ã‚Â½QSIÃƒÂ¯Ã‚Â¿Ã‚Â½)
*/
...
2 in_time
	...
	10 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 5000 [*0.1 ms] = 1 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 500 ms
	50 = 5 ms (default)
3 out_time
	[ 15:0 ]
...
4 gain
	...
	-180 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +60 [*0.1 dB] = -18 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +6 dB digital radio signal gain
	0 = 0 dB (default)
*/
...
1 volume
	[ 15:0 ] (signed)
	audio volume
	-599 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +240 = -60 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +24 dB volume
	0 = 0 dB (default)
*/
...
1 source
	...
	32 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S digital audio input (IIS_SD_0)
...
1 signal
	[ 15:0 ]
	audio output
	33 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S digital audio IIS_SD_1 (output)
	128 = DAC L/R output
2 source
	[ 15:0 ]
	source
	4 = analog radio
	32 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S digital audio IIS_SD0 (input)
...
[ 15:0 ]
	...
	32 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S digital audio IIS_SD_0 (input)
	33 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S digital audio IIS_SD_1 (output)
(2) mode
	0 = off (default)
...
(3) format
	...
	16 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S 16 bits (fIIS_BCK = 32 * samplerate)
	32 = IÃƒÂ¯Ã‚Â¿Ã‚Â½S 32 bits (fIIS_BCK = 64 * samplerate) (default)
...
2 gain
	...
	-120 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +60 [*0.1 dB] = -12 ÃƒÂ¯Ã‚Â¿Ã‚Â½ +6 dB external source signal gain
	0 = 0 dB (default)
*/
...
2 offset
	[ 15:0 ]
	DC offset
	-32768 ÃƒÂ¯Ã‚Â¿Ã‚Â½ + 32767 (* 1 LSB of 16 bit) = max negative ÃƒÂ¯Ã‚Â¿Ã‚Â½ max positive.
	0 = no offset (default)
3 amplitude1
	[ 15:0 ] signed
	wave 1 amplitude
	-300 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 0 (*0.1 dB) = -30 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 0 dB
	-200 = -20 dB (default)
4 frequency1
	[ 15:0 ]
	wave 1 frequency
	10 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 20000 (*1 Hz) = 10 Hz ÃƒÂ¯Ã‚Â¿Ã‚Â½ 20 kHz
	400 = 400 Hz (default)
5 amplitude2
	[ 15:0 ] signed
	wave 2 amplitude
...
3 feature
	...
	2 = general purpose output ÃƒÂ¯Ã‚Â¿Ã‚Â½0ÃƒÂ¯Ã‚Â¿Ã‚Â½ (FM / AM)
	3 = general purpose output ÃƒÂ¯Ã‚Â¿Ã‚Â½1ÃƒÂ¯Ã‚Â¿Ã‚Â½ (FM / AM)
	257 = output RDS (FM : see cmd 81 ÃƒÂ¯Ã‚Â¿Ã‚Â½DAVNÃƒÂ¯Ã‚Â¿Ã‚Â½)
	258 = output QSI (FM / AM : see cmd 82 ÃƒÂ¯Ã‚Â¿Ã‚Â½timer and AF_Update flagÃƒÂ¯Ã‚Â¿Ã‚Â½)
	259 = output QSI + RDS (active ÃƒÂ¯Ã‚Â¿Ã‚Â½lowÃƒÂ¯Ã‚Â¿Ã‚Â½ if ÃƒÂ¯Ã‚Â¿Ã‚Â½DAVNÃƒÂ¯Ã‚Â¿Ã‚Â½ is active or ÃƒÂ¯Ã‚Â¿Ã‚Â½QSIÃƒÂ¯Ã‚Â¿Ã‚Â½ is active)
	260 = output RDDA (FM : see cmd 81 ÃƒÂ¯Ã‚Â¿Ã‚Â½RDDA, RDCL legacy optionÃƒÂ¯Ã‚Â¿Ã‚Â½)
	261 = output RDCL (FM : see cmd 81 ÃƒÂ¯Ã‚Â¿Ã‚Â½RDDA, RDCL legacy optionÃƒÂ¯Ã‚Â¿Ã‚Â½)
	262 = output AGC (FM : see cmd 11 ÃƒÂ¯Ã‚Â¿Ã‚Â½AGC step extensionÃƒÂ¯Ã‚Â¿Ã‚Â½)
*/
...
1 mode
	[ 15:0 ]
	1 = goto ÃƒÂ¯Ã‚Â¿Ã‚Â½activeÃƒÂ¯Ã‚Â¿Ã‚Â½ state with operation mode of ÃƒÂ¯Ã‚Â¿Ã‚Â½radio standbyÃƒÂ¯Ã‚Â¿Ã‚Â½
*/
...
4 wam
	[ 15:0 ]
	FM wideband-AMÃƒÂ¯Ã‚Â¿Ã‚Â½ multipath detector
...
6 bandwidth
	[ 15:0 ]
	IF bandwidth
	FM 560 ...3110 [*0.1 kHz] = IF bandwidth 56 ... 311 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½K wide
	AM 30 ... 80 [*0.1 kHz] = IF bandwidth 3 ... 8 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½K wide
7 modulation
	[ 15:0 ]
	modulation detector
...
/*
status	= 1 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 320 (* 0.1 ms) = 0.1 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 32 ms after tuning
level		= -200 ... 1200 (0.1 * dBuV) = -20 ... 120 dBuV RF input level
usn		=  0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1 %) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100% relative usn detector result
wam		=  0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1 %) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100% relative wam detector result
offset	 = -1200 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1200 (*0.1 kHz) = -120 kHz ÃƒÂ¯Ã‚Â¿Ã‚Â½ 120 kHz radio frequency error
bandwith	 = FM 560 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 3110 [*0.1 kHz] = IF bandwidth 56 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 311 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½ wide
			AM 30 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 80 [*0.1 kHz] = IF bandwidth 3 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 8 kHz; narrow ÃƒÂ¯Ã‚Â¿Ã‚Â½ wide
modulation	 = FM 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 [*0.1 %] = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100% modulation = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 75 kHz FM dev.
				1000 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2000 [*0.1 %] = 100% ÃƒÂ¯Ã‚Â¿Ã‚Â½ 200% over-modulation range
			AM 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 [*0.1 %] = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100% AM modulation index
			1000 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 2000 [*0.1 %] = 100% ÃƒÂ¯Ã‚Â¿Ã‚Â½ 200% peak modulation range
...
1 status
	...
	1 = type B; A-B-CÃƒÂ¯Ã‚Â¿Ã‚Â½-D group (with PI code in block A and CÃƒÂ¯Ã‚Â¿Ã‚Â½)
	[11:10] = reserved
...
1 input_att
	...
	FM 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 420 (0.1* dB) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 42 dB attenuation
	AM 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 420 (0.1* dB) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 42 dB attenuation
2 feedback_att
	[ 15:0 ]
	RF AGC feedback attenuation
	FM 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 60 (0.1* dB) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 6 dB attenuation
	AM 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 180 (0.1* dB) = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 18 dB attenuation
*/
...
1 softmute Softmute control state
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1%) = 0 % minimum ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100 % max. softmute attenuation
2 highcut Highcut control state
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1%) = 0 % minimum ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100 % max. audio freq. limitation
3 stereo FM Stereo blend control state
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 1000 (*0.1%) = 0 % minimum ÃƒÂ¯Ã‚Â¿Ã‚Â½ 100 % max. stereo att. (= mono)
*/
...
1 device 
	...
	8 = TEF668x ÃƒÂ¯Ã‚Â¿Ã‚Â½Atomic-2ÃƒÂ¯Ã‚Â¿Ã‚Â½ series
	[ 7:0 ] variant identifier
	15 = TEF6653 ÃƒÂ¯Ã‚Â¿Ã‚Â½Atomic-2 StandardÃƒÂ¯Ã‚Â¿Ã‚Â½
	13 = TEF6657 ÃƒÂ¯Ã‚Â¿Ã‚Â½Atomic-2 PremiumÃƒÂ¯Ã‚Â¿Ã‚Â½
	12 = TEF6659 ÃƒÂ¯Ã‚Â¿Ã‚Â½Atomic-2 Premium DRÃƒÂ¯Ã‚Â¿Ã‚Â½
2 hw_version 
	hardware version
	[ 15:8 ] major number
	1 = ÃƒÂ¯Ã‚Â¿Ã‚Â½V1ÃƒÂ¯Ã‚Â¿Ã‚Â½
	[ 7:0 ] minor number
	0 = ÃƒÂ¯Ã‚Â¿Ã‚Â½BÃƒÂ¯Ã‚Â¿Ã‚Â½
3 sw_version 
	firmware version
	[ 15:8 ] major number
	1 = ÃƒÂ¯Ã‚Â¿Ã‚Â½1ÃƒÂ¯Ã‚Â¿Ã‚Â½
	[ 7:0 ] minor number
	1 = ÃƒÂ¯Ã‚Â¿Ã‚Â½.01ÃƒÂ¯Ã‚Â¿Ã‚Â½
*/
...
module 64 APPL
cmd 131 Get_LastWrite | size/module, cmd/ index, parameter1, parameter2, parameter3, ÃƒÂ¯Ã‚Â¿Ã‚Â½

index 
1 size/module transmission size (number of parameters) and module number
	[ 15:8 ] = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 6 : number of parameters of the last write transmission
	[ 7:0 ] = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 255 : module value of the last write transmission
2 cmd/index
	command byte number and index byte value
	[ 15:8 ] = 0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 255 : cmd value of the last write transmission
	[ 7:0 ] = 0 ... 255 : index value of the last write transmission
3 parameter1 first parameter
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 65535 = value of the first parameter (when available)
4 parameter2 second parameter
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 65535 = value of the second parameter (when available)
5 parameter3 third parameter
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 65535 = value of the third parameter (when available)
6 parameter4 fourth parameter
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 65535 = value of the fourth parameter (when available)
7 parameter5 fifth parameter
	0 ÃƒÂ¯Ã‚Â¿Ã‚Â½ 65535 = value of the fifth parameter (when available)
*/
